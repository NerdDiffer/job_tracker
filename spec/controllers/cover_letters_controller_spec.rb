...
RSpec.describe CoverLettersController, type: :controller do
  ...
  # CoverLettersController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "GET #show" do
    it "assigns the requested cover_letter as @cover_letter" do
      cover_letter = CoverLetter.create! valid_attributes
      get :show, {:id => cover_letter.to_param}, valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested cover_letter as @cover_letter" do
      cover_letter = CoverLetter.create! valid_attributes
      get :edit, {:id => cover_letter.to_param}, valid_session
      expect(assigns(:cover_letter)).to eq(cover_letter)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new CoverLetter" do
        expect {
          post :create, {:cover_letter => valid_attributes}, valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved cover_letter as @cover_letter" do
        post :create, {:cover_letter => invalid_attributes}, valid_session
        expect(assigns(:cover_letter)).to be_a_new(CoverLetter)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested cover_letter" do
        cover_letter = CoverLetter.create! valid_attributes
        put :update, {:id => cover_letter.to_param, :cover_letter => new_attributes}, valid_session
        cover_letter.reload
      ...
      it "assigns the requested cover_letter as @cover_letter" do
        cover_letter = CoverLetter.create! valid_attributes
        put :update, {:id => cover_letter.to_param, :cover_letter => valid_attributes}, valid_session
        expect(assigns(:cover_letter)).to eq(cover_letter)
      end
    ...
    context "with invalid params" do
      it "assigns the cover_letter as @cover_letter" do
        cover_letter = CoverLetter.create! valid_attributes
        put :update, {:id => cover_letter.to_param, :cover_letter => invalid_attributes}, valid_session
        expect(assigns(:cover_letter)).to eq(cover_letter)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested cover_letter" do
      cover_letter = CoverLetter.create! valid_attributes
      expect {
        delete :destroy, {:id => cover_letter.to_param}, valid_session
      }.to change(CoverLetter, :count).by(-1)
    end
